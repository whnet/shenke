...
class Orders(models.Model):
    STATUS_CHOICE = [('0', '未付款'), ('1', '待接单'),('2', '已退款'), ('3', '进行中'),('4', '待评价'), ('5', '已完成'), ('6', '拒单')]
...
class Withdraw(models.Model):
    ...
    openid = models.TextField(max_length=50, verbose_name='用户识别码', blank=True, default='')
    price = models.DecimalField(default=0, decimal_places=2, max_digits=15, verbose_name='金额')
    partner_trade_no = models.TextField(max_length=32, verbose_name='商户订单号', blank=True, default='')
    payment_no = models.TextField(max_length=64, verbose_name='微信付款单号', blank=True, default='')
    payment_time = models.TextField(max_length=32, verbose_name='付款成功时间', blank=True, default='')
    status = models.CharField(max_length=1,
                              choices=STATUS_CHOICE,
                              verbose_name='状态', default=0)
